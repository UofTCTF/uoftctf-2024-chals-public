...
// gcc -o Challenge1 Challenge1.c -pthread
...
void* handleClient(void* client_socket_ptr) {
    ...
    char initialMessage[] = "Enter the frequency in MHZ for channel 6: ";
    ...
    if (strcmp(receivedData, "2437\n") == 0) {
        char successMessage[] = "Access granted! The Flag is {FCC_ID_Recon}!";
...
int main() {
    ...
    server_addr.sin_port = htons(3895);
    ...
    printf("Server listening on port 3895...\n");
