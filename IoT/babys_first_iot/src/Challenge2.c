...
// gcc -o Challenge2 Challenge2.c -pthread
...
void* handleClient(void* client_socket_ptr) {
    ...
    char initialMessage[] = "Enter the company that manufactures the processor for the FCC ID Q87-WRT54GV81 ";
    ...
    if (strcmp(receivedData, "Broadcom\n") == 0) {
        char successMessage[] = "Access granted! The Flag is {Processor_Recon}!";
...
int main() {
    ...
    server_addr.sin_port = htons(6318);
    ...
    printf("Server listening on port 6318...\n");
