...
// gcc -o Challenge6 Challenge6.c -pthread
...
void* handleClient(void* client_socket_ptr) {
    ...
    char initialMessage[] = "Enter the backdoor password: ";
    ...
    if (strcmp(receivedData, "IoTBackDoor\n") == 0) {
        char successMessage[] = "Access granted! The Flag is {Develper_BackDoor}!";
...
int main() {
    ...
    printf("Server listening on port 4545...\n");
